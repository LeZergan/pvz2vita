...
#ifndef USE_PVR_PSP2
/* In PVR mode, these come from <EGL/egl.h>. In vitaGL mode we declare stubs. */
...
/* Android Native Window stubs - needed in both vitaGL and PVR modes */
